    ...
    <div>
      ...
      <div className="relative mx-auto min-h-screen border-theme border-l-3 border-r-3 border-b-3">
        ...
        >
          ...
          <div
            className={`${currentTheme === 'light' ? 'bg-hip-verde-escuro' : 'bg-hip-verde-claro'} text-left text-black border-theme w-full pb-10 pt-6 px-6`}
          >
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row gap-2">
                  ...
                  />
                  <div className="flex gap-2 sm:justify-center mx-auto">
                    <button
                ...
                <div className="space-y-2">
                  <div className="flex flex-wrap gap-2 xs:flex xs:justify-center">
                    {[
                      ...
                      <button
                        ...
                        className={`cursor-pointer px-3 py-2 border-2 border-theme font-sometype-mono text-sm transition-colors ${searchField === field.value
                    ...
                    {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 sm:px-3 py-1 border-2 border-theme font-dirty-stains text-xs sm:text-sm transition-colors min-w-[32px] sm:min-w-[36px] ${pageNum === currentPage
                  ...
                  >
                    ...
                    <div className="p-4 flex-1 flex flex-col">
                      ...
                      <div className="mt-4 pt-3 border-t-2 border-theme flex justify-between items-center">
                        ...
                        <button className="text-xs sm:text-sm bg-white text-theme cursor-pointer px-2 sm:px-3 py-1 border border-theme font-dirty-stains hover:bg-black hover:text-white transition-colors whitespace-nowrap">
                          Ver Detalhes
                        </button>
                      </div>
                    </div>
        ...
        >
          <div
            className={`${currentTheme === 'light' ? 'bg-hip-verde-escuro' : 'bg-hip-verde-claro'} text-left text-black border-theme w-full pb-10 pt-6 px-6 mb-12 border-theme border-t-3`}
          >
            <h2 className="text-3xl text-bold md:text-4xl lg:text-5xl xl:text-6xl md:pl-6 mb-6 text-bold">
