  ...
  return (
    <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none transition-all duration-300 ${
      ...
      <div className="bg-black/20 backdrop-blur-sm rounded-full p-8">
        <div className="bg-[#fae523] border-2 border-black rounded-full p-4 shadow-xl animate-pulse">
      ...
      <div className={`mt-4 text-center transition-all duration-300 ${
        ...
        <div className="bg-black/90 backdrop-blur-sm rounded-lg px-4 py-2 border border-white/20">
          <p className="font-sometype-mono text-sm text-white font-bold">
            🔒 Mapa Travado
          </p>
          <p className="font-sometype-mono text-xs text-white/80">
